...
def update_weights(weights, sigma, robot_choice, last_play, last_result):
    if not last_result:
        ...
        weights[last_result][last_play][robot_choice] = weights[last_result][last_play][robot_choice]*(1-sigma)
    return weights
...
def play(player_choice, weights, last_result, last_play):
    ...
    elif (robot_choice == "R" and player_choice == "P") or (robot_choice == "S" and player_choice == "R") or (robot_choice == "P" and player_choice == "S"):
